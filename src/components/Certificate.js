...
export const Certificate = () => {
  const certificate = [
    ...
    }, 
    {
        ...
        hover: 'Lembaga Pengembangan Komputerisasi Universitas GunadarmaLembaga Pengembangan Komputerisasi Universitas Gunadarma',
    }, 
  ];
          ...
          <Row>
            {certificate.map((cert, index) => (
              <Col key={index} xs={11} md={12} className="mx-auto">
                <div className="certificate-item" onClick={() => openLightboxUx(cert.image)}>
