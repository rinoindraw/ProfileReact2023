            ...
            <Container>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="me-auto">
                        ...
                        <Nav.Link href="#organization" className={activeLink === 'organization' ? 'active navbar-link' : "navbar-link"} onClick={() => onUpdateActiveLink('organization')}>Organization</Nav.Link>
                    ...
                    <span className="navbar-text">
                        <div className="social-icon">
                            <a href="https://www.linkedin.com/in/rino-indra-wicaksono-43582b235/" target="_blank"><img src={navIcon1} alt="" /></a>
                            <a href="https://www.instagram.com/rinoindraw/" target="_blank"><img src={navIcon3} alt="" /></a>
                        </div>
                    </span>
                </Navbar.Collapse>
            </Container>
